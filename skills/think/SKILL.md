---
name: think
description: Apply the 10-stage OBSERVE, OBSERVE, LISTEN, THINK, CONNECT, CONNECT, FEEL, ACCEPT, CREATE, GROW loop to consequential or ambiguous reasoning and decisions. Use for think this through, deep think, architecture review, postmortem, tradeoff analysis, or challenges to assumptions. A reasoning review, not a vault health check or repair.
---
...
edit files, apply a plan, commit, or publish. If the CREATE stage recommends a
change, hand it to the mutation skill after the user authorizes that operation.
...
questions whose answers could change the outcome.
...
it, and what lesson is reusable. Saving the lesson is a separate `save`.

## Verification discipline

Before calling the work complete:

1. Test the highest-risk claim or state why it remains untested.
2. Seek disconfirming evidence, not only supporting examples.
3. Match verification effort to blast radius and reversibility.
4. Report the actual commands, sources, artifacts, or observations used.
5. Separate a passing check from the broader correctness it does not establish.
6. Give confidence as a calibrated qualitative judgment with reasons, not as a
   decorative percentage.

## Output shape

Adapt the headings to the task, but keep these outcomes:
...
observation or a misunderstood requirement.
