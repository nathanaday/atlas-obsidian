...
> [Stub](<../stubs/Replace tasks with threads.md>) → **Spec** → [Plan](<../plans/Replace tasks with threads.md>) → [Receipt](<../receipts/Replace tasks with threads.md>)
...
- `atlas-obsidian upgrade` turns 2.x task pages into threads.
- `make test` passes.
