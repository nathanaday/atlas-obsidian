...
- Run inside the folder: `atlas-obsidian plant . "..."` and `claude`, as before.
- Run with a PATH from elsewhere: `atlas-obsidian plant NAME "..."` and `atlas-obsidian open-claude NAME`.
