...
> **Stub** → [Spec](<../specs/Consolidate the project and the knowledge base into one entity.md>) → [Plan](<../plans/Consolidate the project and the knowledge base into one entity.md>) → [Receipt](<../receipts/Consolidate the project and the knowledge base into one entity.md>)
